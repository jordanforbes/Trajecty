...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference("Truck.count") do
      post trucks_url, params: { truck: { container_num: @truck.container_num, location: @truck.location, name: @truck.name, user_id: @truck.user_id } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { container_num: @truck.container_num, location: @truck.location, name: @truck.name, user_id: @truck.user_id } }
